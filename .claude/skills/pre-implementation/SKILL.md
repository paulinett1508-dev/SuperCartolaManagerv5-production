...
description: Verificação pré-implementação: detectar duplicação, encontrar solução mais simples, cruzar com código existente. Keywords: antes de implementar, pre-implementation, duplicação, solução mais simples, verificar antes, DRY
---
