...
description: Estratégia de branches: trunk-based vs GitFlow, nomenclatura, proteção de branch, PRs. Keywords: branch, git flow, trunk based, feature branch, nomenclatura de branch, git
---
