---
name: schema-design
description: Design de schema: normalização, seleção de ORM, índices, migrations seguras, modelagem MongoDB. Keywords: schema, modelagem, design de banco, normalização, índices, ORM, MongoDB schema
---
