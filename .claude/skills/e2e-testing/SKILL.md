---
name: e2e-testing
description: Testes E2E: pirâmide de testes, Page Object Model, Playwright, Cypress, CI, smoke tests. Keywords: e2e, end to end, playwright, cypress, testes de interface, smoke test
---
