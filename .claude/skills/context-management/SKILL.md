...
description: Gerenciamento de contexto: context rot, contextos frescos, handover protocol, quando fazer /compact ou /clear. Keywords: contexto, context, compact, clear, handover, sessão longa, context rot
---
