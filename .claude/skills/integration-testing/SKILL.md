...
description: Testes de integração: banco isolado, testes de API, contratos, gerenciamento de dados de teste. Keywords: integration test, supertest, banco de teste, API test, teste de integração
---
