...
description: Checklist pré-deploy: testes, segurança, migrations, rollback plan, zero-downtime. Keywords: deploy, pre-deploy, checklist, rollback, producao, release, go-live
---
