---
name: model-routing
description: Roteamento de modelos Claude por tipo de tarefa: Opus para arquitetura/decisões complexas, Sonnet para implementação, Haiku para boilerplate. Keywords: modelo, opus, sonnet, haiku, model routing, qual modelo usar, claude
---
