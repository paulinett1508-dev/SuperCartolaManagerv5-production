---
name: unit-testing
description: Testes unitários: padrão AAA, coverage 80%+, mocking, casos de borda, testes assíncronos. Keywords: unit test, jest, vitest, coverage, mock, testar, tdd, teste unitário
---
