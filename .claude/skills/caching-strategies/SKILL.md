...
description: Estratégias de cache: camadas L1-L3, cache-aside, TTL, invalidação, Redis keys, stale-while-revalidate. Keywords: cache, TTL, invalidação, redis, cache-aside, stale, estratégias de cache
---
