...
description: Design REST API: nomenclatura de rotas, HTTP methods, status codes, paginação, versionamento. Keywords: REST, API design, rotas, HTTP, status code, paginação, versionamento de API, endpoints
---
